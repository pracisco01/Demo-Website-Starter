...
document.addEventListener("DOMContentLoaded", () => {
  ...
  tabButtons.forEach((button) => {
    button.addEventListener("click", () => {
      ...
      // Update the transparency of the tab bar
      tabsContainer.classList.remove(
        "tabs-transparency-tab1",
        "tabs-transparency-tab2",
        "tabs-transparency-tab3",
  ...
  // Get reference to the telephone button
  const telephoneButton = document.getElementById("telephone");
  ...
  function getCallbackDelay() {
    ...
    const delayCallbackMinutes = document.getElementById(
      "delayCallbackMinutes"
    );
